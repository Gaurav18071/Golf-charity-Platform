                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">{c._count.donations} donations • Updated {formatDate(c.updatedAt)}</p>
                    </div>
                    <span className={`rounded-full px-2.5 py-0.5 text-xs font-semibold shrink-0 ${STATUS_STYLES[c.status as CampaignStatusType]}`}>
                      {c.status}
                    </span>
                  </div>
                  ...
                  <div className="space-y-1.5 pt-1">
                    <div className="flex justify-between text-xs font-semibold">
                      <span className="text-emerald-700">Raised: {formatCurrency(Number(c.currentAmount))}</span>
                      <span className="text-slate-500">Goal: {formatCurrency(Number(c.goalAmount))}</span>
                    </div>
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-slate-100">
                    <Link
                      href={`/campaigns/${c.id}`}
                      className="flex-1 inline-flex items-center justify-center gap-1 rounded-xl bg-slate-100 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-200 transition"
                    >
                    ...
                    <Link
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1 rounded-xl bg-emerald-50 py-2 text-xs font-semibold text-emerald-700 hover:bg-emerald-100 transition"
                    >
                    ...
                    <Link
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1 rounded-xl bg-blue-50 py-2 text-xs font-semibold text-blue-700 hover:bg-blue-100 transition"
                    >
